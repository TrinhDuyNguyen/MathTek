...
const CONTACT = [
  {
    ...
    icon: <CallCalling size='40' color='#FFB145' variant='Bold' />,
  },
  {
    title: 'Email',
    subTitle: 'admin@gmail.com',
    icon: <Sms size='40' color='#FFB145' variant='Bold' />,
  },
  {
    title: 'Địa chỉ',
    subTitle: '9 Vũ Phạm Hàm, Yên Hòa, Cầu Giấy, Hà Nội',
    icon: <Location size='40' color='#FFB145' variant='Bold' />,
  },
];
        ...
        <div className='pb-32 px-6 mt-4 md:max-w-3xl max-w-sm lg:max-w-5xl xl:max-w-7xl mx-auto w-full flex lg:flex-row flex-col gap-8 items-stretch'>
          ...
          >
            <div>
              ...
              <div className='font-bold text-3xl leading-12 mt-2 text-primary-main'>
            ...
            <Button className='h-12 bg-primary-main' type='submit'>
